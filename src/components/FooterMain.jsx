    ...
    return (
        <div>
            <div className={style.footer}>
                <div className={`${style.main_row} ${style.flex}`}>
                    <div className={style.fotr_col_2}>
                        <h3>Information</h3>
                        ...
                        <div className={style.fotr_col_1}>
                            ...
                            <tbody className={style.share_icon}>
                                <td>
                                    <img style={{ width: "150px", height: "40px" }} src="https://static.naukimg.com/s/0/0/i/new-homepage/android-app.png" alt="google" />
                                </td><br />
                                <td><img style={{ width: "150px", height: "40px" }} src="https://static.naukimg.com/s/0/0/i/new-homepage/ios-app.png" alt="apple" /></td>
                            </tbody>
                        </div>
                    </div>
                    <div className={style.fotr_col_3}>
                        <h3>Jobseekers</h3>
                    ...
                    <div className={style.fotr_col_4}>
                    ...
                    <div className={style.fotr_col_5}>
                        <h3>Employers</h3>
